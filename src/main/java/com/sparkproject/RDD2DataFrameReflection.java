...
/**
 * @author : avloger
 * @date : 2021/11/23 23:33
 */
public class RDD2DataFrameReflection {	public static void main(String[] args) {
    // 创建普通的RDD
    ...
    JavaRDD<String> lines = sc.textFile("C:\\Users\\ASUS\\Desktop\\students.txt");
